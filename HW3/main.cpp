...
void display()
{
    ...
    GLint krUniform = glGetUniformLocation(gProgram[0], "kr"); 
    GLint kgUniform = glGetUniformLocation(gProgram[0], "kg");
    GLint kbUniform = glGetUniformLocation(gProgram[0], "kb");
	//glLoadIdentity();
	//glTranslatef(-2, 0, -10);
...
int main(int argc, char** argv){
    ...
    window = glfwCreateWindow(width, height, "Bunny Crush", NULL, NULL);
